...
var CACHE_NAME = "miroir-mm-v4"; // v4 : bump nécessaire car index.html a beaucoup changé (première phrase, mouvement de caisse manuel, rafraîchissement des rapports...)
var APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
